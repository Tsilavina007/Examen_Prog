...
describe('level2', () => {
    it('should return the number of pairs if there are pairs ', () => {
        assert.strictEqual(level2([4, "1x2x3","1x2x3", "2x3x4", "3x4x5"]), 2);
        assert.strictEqual(level2([5, "1x2x3","1x2x3", "2x3x4", "2x3x4", "3x4x5"]), 4);
    });
...
describe('level3', () => {
    ...
    it('should return the volume contained at the end of the recipe in the left correctly', () => {
        assert.strictEqual(level3(6, ["ADD 5","SWAP", "ADD 3", "JUMP -2", "TRANSFER", "ADD 2", "SWAP"]),"2 11");
